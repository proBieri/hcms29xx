...
void hcms29xx::setString(const char * _displayString)  {
...
void hcms29xx::loadControlRegister(uint8_t dataByte) {
...
void hcms29xx::loadAllControlRegisters(uint8_t dataByte) {
