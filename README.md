...
An Arduino library for the HCMS-290x LED Displays (slightly modified by me (Andrew Wyatt) to allow multiples of 4 characters, and direct access to the Dot Register).
